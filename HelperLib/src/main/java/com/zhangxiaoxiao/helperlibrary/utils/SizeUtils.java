...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = HelperConfig.getContext().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = HelperConfig.getContext().getResources().getDisplayMetrics().scaledDensity;
    ...
    public static float applyDimension(final float value, final int unit) {
        DisplayMetrics metrics = HelperConfig.getContext().getResources().getDisplayMetrics();
        switch (unit) {
